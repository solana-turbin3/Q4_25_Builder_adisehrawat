...
mod test {
    ...
    fn base58_to_wallet() {
        ...
        println!("You wallet file format is: ");
    ...
    #[test]
    fn wallet_to_base58() {
        println!("Input your private key as a JSON byte array (eg: [12,34,..,..)");
        let stdin = io::stdin();
        let wallet = stdin
            .lock()
            .lines()
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("7qpCbG1WfLWsh4FhfoD5i5RbcVnFXuRbruG6ExhuRhe9").unwrap();
    ...
    fn empty_wallet() {
        ...
        let message = Message::new_with_blockhash(
            &[transfer(&keypair.pubkey(), &to_pubkey, 0u64)],
            Some(&keypair.pubkey()),
            &recent_blockhash
        );
    ...
    fn enroll() {
        ...
        let (authority_pda, _authoritybump) = Pubkey::find_program_address(
            authority_seeds,
        ...
        let accounts = vec![
            ...
            AccountMeta::new(mpl_core_program, false),
